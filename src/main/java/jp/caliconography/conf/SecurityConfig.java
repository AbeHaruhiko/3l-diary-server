...
import jp.caliconography.conf.auth.firebase.FirebaseAuthenticationProvider;
import jp.caliconography.conf.auth.firebase.FirebaseFilter;
...
public class SecurityConfig {
	...
	protected static class AuthenticationSecurity extends GlobalAuthenticationConfigurerAdapter {
		...
		@Value("${3l-diary.firebase.enabled}")
